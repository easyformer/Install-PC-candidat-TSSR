...
:: Version:       1.0.6 + Add SKIP_ADWCLEANER_SCAN (-sac) switch. Thanks to u/fr0stedfl4ke
...
:: Script version
set TRON_SETTINGS_SCRIPT_VERSION=1.0.6
set TRON_SETTINGS_SCRIPT_DATE=2023-08-xx
